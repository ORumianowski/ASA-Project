...
```
Ok, ils n y a pas de NA dans les données environnement et floristique.
...
```
Ok, tous les stations présentent des individus.
...
On observe que sans l'altitude le test de Mantel n'est plus significative. Nous poursuivrons tout de même l'analyse avec une pCCA, car au vu de l'échantillonnage on s'attend à de l'autocorrélation spatiale. Cela permettra aussi une meilleure comparaison avec l'analyse précendent (avec altitude). 
...
**On constate que la variable Altitude à une grande importance pour structuré la comminauté des spèces végétale **.
