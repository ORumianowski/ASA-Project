...
En effectuant la fonction ordistep plusieurs fois, nous avons remarqué que la variable Mg est parfois conservée, parfois retirée. Etant donné que le nombre d'observations est largement suffisant par rapport aux nombres de variables (97 observations pour 4 ou 5 variables), nous avons décidé de garder la variable Mg. Nous avons priviligié un critère écologique/biologique à un critère statistique (non discriminant).
