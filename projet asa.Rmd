...
Finalement, les résultats de la pCCA sont significatifs (p=0,001). L'inertie totale de l'analyse est **7.97**, l'environnement en explique **11,6%** et les données spatiales **8,8%**.

Les 2 premiers axes representent **56,6%** de la variance expliquée par l'environnement (indépendamment de l'effet spatial), et **6,6%** de la variance totale.
...
Dans cette 2ieme analyse, les resultats de la pCCA sont significatifs (p=0,001). L'inertie totale de l'analyse est 7.97, l'environnement en explique **7,8%** et les donnees spatiales **8,8%**.
